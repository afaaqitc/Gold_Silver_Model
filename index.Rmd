...
model_chart<-
model %>% 
pivot_longer(!Date,names_to = "Levels",values_to = "Prices") %>% mutate(Date=as.POSIXct(Date)) %>% 
ggplot(aes(x=Date,y=Prices,color=Levels,group=Levels))+
geom_line(size=1)+geom_point(color="black",size=1)+
geom_label(aes(label=round(Prices/1000,2)),nudge_x = 0.25,nudge_y = 0.25)+
scale_color_manual(values = c("#c23616","#192a56"))+
labs(x="",y="",title = "Gold Forecast Model Next 14 Month",
subtitle ="Focus Data Period: Oct 2014 - Sep 2024" ,caption = "Labels in Thousands")+
...
ggplot(aes(x=mn,y=round(prices,2),color=levels,group=levels))+
geom_line(size=1)+geom_point()+scale_color_manual(values =  c("#2f3640","#40739e","#c23616"))+
labs(x="",y="",title = "Silver Detect Last 10 Months Prices Model",subtitle = "Data Focus Period: Jan 2010 - Dec 2023")+
theme_classic()+theme(axis.text.x = element_text(colour = "black",face = "bold"),axis.text.y = element_text(colour = "black",face = "bold"),legend.position = "top",title = element_text(size=14,color="#2f3640",face = "bold"))+
scale_x_datetime(date_breaks = "month",date_labels = "%b")+
geom_label(aes(label = round(prices,2)),nudge_x = 0.25,nudge_y = 0.25)
...
geom_point(color="black") +scale_color_manual(values = c("#c23616","#30336b"))+
scale_x_datetime(date_breaks ="month" ,date_labels = "%b")+labs(x="",y="",title = "Silver Forecast Next 14 Months",subtitle = "Data Foucus Period: Jan 2010 - Oct 2024")+scale_y_continuous(limits = c(33,43))+
theme_bw()+theme(axis.text.x = element_text(colour = "black",face = "bold"),
axis.text.y = element_text(colour = "black",face = "bold"),title = element_text(colour = "#30336b",face = "bold"),legend.position = "top")+
geom_label(aes(label = round(price,2)),nudge_x = 0.25,nudge_y = 0.25)+scale_y_continuous(limits = c(33,44.5))
